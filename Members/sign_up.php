...
<div class = "right_area">
		<a href="../index.php"class = "signup_btn">Back</a>
	</div>  
<div class="user">
    ...
    <form class="form" action="sign_up.php" method="post">
        ...
        <div class="dropdown">
                <select type="text" name="workout" class="dropbtn" required="true">
                    <div class="dropdown-content">
                        <option  class= "button" selected disabled >Work-out</option> 
            ...
            <input type="submit"name="register"class="btn"value="REGISTER" style="
    display: block;
    width: 100%;
    padding: 20px;
    font-family: &quot;Roboto&quot;;
